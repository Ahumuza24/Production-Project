...
const importRules = () => ({
  ...
  'import/newline-after-import': 0, // ⛔ Allow any spacing after imports
...
const unusedImportsRules = () => ({
  'unused-imports/no-unused-imports': 1, // ✅ Warn on unused imports
  'unused-imports/no-unused-vars': [
    1, // ✅ Warn on unused variables
...
const sortImportsRules = () => ({
  // ⛔ Disable all import sorting rules
